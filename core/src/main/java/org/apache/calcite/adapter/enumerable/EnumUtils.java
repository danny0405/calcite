...
public class EnumUtils {
  ...
  static Expression windowSelector(
    ...
    // TODO: Should generate the wmColExpr directly in RexToLixTranslator.
    final Expression wmColExpr =
        inputPhysType.fieldReference(parameter, (int) ((ConstantExpression) wmColumnIdx).value,
            outputPhysType.getJavaFieldType(expressions.size()));
